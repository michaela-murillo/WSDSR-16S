...
filepath <- "C:/Users/Mikki/Documents/WSD/ONS_week1-4/serviceRun/raw_batch11"

# Path to dir for storing excel files
# Note: must replace \ with \\
excelOutput_path <- "C:\\Users\\Mikki\\Documents\\WSD\\ONS_week1-4\\serviceRun\\raw_batch11"

# Batch name
batchName <- "Batch011"

# Sample collection date
samplingdate <- "20231214"
